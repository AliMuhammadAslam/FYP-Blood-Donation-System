...
const PatientDetails = () => {
    ...
    return (
        <SafeAreaView style={styles.container}>
            <Header title="Patient Details" isRed={false} />
            <View style={{ marginTop: 20, alignItems: 'center', width: '100%' }}>
                <Image style={{ width: 130, height: 130, borderRadius: 70 }} source={sample_image} />
                <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 65, marginLeft: 100 }}>
                    <View style={{ alignItems: 'center' }}>
                        <Text style={{ color: 'black', fontSize: 22, marginTop: 10, fontWeight: '600' }}>Zulfiqar Khan</Text>
                ...
                <View style={{ flexDirection: 'row', width: '94%', marginTop: 10 }}>
                    <View style={{ width: '70%', gap: 5 }}>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Text style={{ fontSize: 18, color: 'black' }}>Gender: </Text>
                            <Text style={{ color: 'grey', fontSize: 16 }}>Male</Text>
                        </View>
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        ...
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            ...
                            <Text style={{ color: 'grey', fontSize: 16, width: '70%' }}>PECHS Block 2 Karachi</Text>
                        </View>
                    </View>
                    <View style={{ alignItems: 'flex-end', gap: 5 }}>
                        ...
                        <ImageBackground style={{ width: 40, height: 50, alignItems: 'center', justifyContent: 'center' }} source={blood_drop}>
                            <Text style={{ color: 'white', fontSize: 24, paddingTop: 10 }}>O-</Text>
                        </ImageBackground>
                    </View>
                </View>
                <Text style={{ color: 'black', fontSize: 18, fontWeight: '600', marginTop: 15, marginBottom: 15 }}>I will Donate 4 times per year</Text>
                <View style={{ width: '94%' }}>
                ...
                <View style={{ flexDirection: 'row', marginTop: 18, alignItems: 'center', gap: 5, width: '94%' }}>
